...
namespace LabWork6._1
{
    class VectorOfRealNumbers
    {
        ...
        //Властивість, що повертає значення поля vector
        public double[] ReturnVector
        {
            get { return vector; }
        }

        //Властивість, що повертає значення поля vectorCapacity
        public int ReturnVectorCapacity
        {
            get { return vectorCapacity; }
        }
    }
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            vector1 = vectorOfRealNumbers1.ReturnVector;
            vector2 = vectorOfRealNumbers2.ReturnVector;

            vectorCapacity1 = vectorOfRealNumbers1.ReturnVectorCapacity;
            vectorCapacity2 = vectorOfRealNumbers2.ReturnVectorCapacity;
